...
export default function TermsAndConditions() {
  const { data: pageData, isLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return pages.find((page: any) => page.type === 'terms' || page.slug === 'terms-and-conditions');
    }
  });
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <Card>
          <CardHeader>
            <CardTitle className="text-3xl font-bold">{pageData?.title || "Terms and Conditions"}</CardTitle>
